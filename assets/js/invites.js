jQuery(document).ready( function() {
	...
	jQuery('#active-rooms').on( 'change', function(e) {
		...
		location = location.substr(0, location.indexOf('meeter/')) + 'meeter/members/';
	...
	function autocomplete(room){
		const options = {
			minLength: 3,
			select: meeter_on_autocomplete_select,
	...
	function meeter_on_autocomplete_select( event, ui) {
	...
	function meeter_refresh_buttons_state(){
